...
export function LoginPage() {
  ...
  return (
    <main className="h-screen overflow-hidden bg-[#080808] text-white">
      <section className="grid h-screen lg:grid-cols-[47%_53%]">
        <aside className="relative hidden h-screen overflow-hidden bg-[#080808] lg:block">
          ...
          />
          <div className="absolute inset-y-0 right-0 w-16 bg-gradient-to-r from-transparent via-[#080808]/18 to-[#080808]" />
        </aside>

        <section className="relative flex h-screen items-center justify-center overflow-hidden px-4 py-4 sm:px-8 lg:-ml-6 lg:pl-0 lg:pr-8">
